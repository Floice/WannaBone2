...
public class CancelSignalNumControl_l : MonoBehaviour
{
    ...
    public void OnButtonClick(int buttonNumber)
    {
        ...
        if(OrderController_lit.instructionList_l.Count >= thisLinenum){
            OrderController_lit.instructionList_l[thisLinenum - 1] = "c" + buttonNumber.ToString();
            print("lit c" + buttonNumber.ToString());
        }else{
            OrderController_lit.instructionList_l.Add("c" + buttonNumber.ToString());
            print("lit c" + buttonNumber.ToString());
        }
    }
}
